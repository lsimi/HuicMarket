...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${basepath}/css/hcss/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${basepath}/css/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="${basepath}/js/hjs/script.js"></script>
	</head>
	...
	<body>
							...
							<div class="search-side">
								...
								<li>
									<div class="i-pic check">
										<img src="${basepath}/images/himages/cp.jpg" />
								...
								<li>
									<div class="i-pic check">
										<img src="${basepath}/images/himages/cp2.jpg" />
		...
		<script>
			window.jQuery || document.write('<script src="${basepath}/css/basic/js/jquery-1.9.min.js"><\/script>');
		</script>
