...
<html>
	...
	<head>
		...
		<link href="${basePath}/css/hcss/bostyle.css" rel="stylesheet" type="text/css">

		<script src="${basePath}/css/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="${basePath}/css/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
	</head>
									...
									<div class="cart-table-th">
										...
										<div class="order-main">
											...
											<ul class="item-list">
												<li class="td td-from">
													<div class="item-img">
														<img src="${basePath}/images/himages/566fda5cN4b8a1675.gif">
													</div>
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>可使用</p><span><img src="${basePath}/images/himages/gift_stamp_1.png"/></span>
													</div>
												</li>
											</ul>
									...
									<div class="cart-table-th">
										...
										<div class="order-main">
											...
											<ul class="item-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>已用完</p><span><img src="${basePath}/images/himages/gift_stamp_2.png"/></span>
													</div>
												</li>
											</ul>
...
<!--已过期-->
											<ul class="item-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<p>已过期</p><span><img src="${basePath}/images/himages/gift_stamp_3.png"/></span>
													</div>
												</li>
											</ul>
