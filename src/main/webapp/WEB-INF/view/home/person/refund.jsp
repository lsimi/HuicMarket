...
<html>
	...
	<head>
		...
		<link href="${basePath}/css/hcss/refstyle.css" rel="stylesheet" type="text/css">
						...
						<div class="refund-aside">
							<div class="item-pic">
								<a href="#" class="J_MakePoint">
									<img src="${basePath}/images/himages/comment.jpg_400x400.jpg" class="itempic">
								</a>
							</div>
						...
						<div class="refund-main">
							...
							<div class="refund-tip">
								<div class="filePic">
									...
									<img src="${basePath}/images/himages/image.jpg" alt="">
								</div>
