...
<script>
	...
	function imgupload()
	{
		$.ajax({
		type:"POST",
		url:"${basepath}/back/goods/updateimg?gId=${backgoods.gId}",
		...
		{
			$("#imgformtip").text(data.msg);
			if(data.status==1)
			{
				$("#mainimg").attr("src","${basepath}"+data.img);
			}
     ...
     <section>
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" placeholder="商品名称..." value="${backgoods.gName}"/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">商品货号：</span>
        <input type="text" class="textbox" placeholder="商品货号..." value="${backgoods.gId}" readonly/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">销量：</span>
         <input type="text" class="textbox" placeholder="商品货号..." value="${backgoods.gSalenum}" readonly/>
       </li>
       <li>
       ...
       <img alt="" src="${basepath}${backgoods.gImg}" width="100px" id="mainimg">
               <label class="uploadImg">
                 <form enctype="multipart/form-data" id="imgform">
		         <input type="file" onchange="imgupload()" name="file"/>
		         </form>
		         <span>上传图片</span>
		       </label>
		<span style="color: red;"  id="imgformtip"></span>
       </li>
       ...
       <li>
       <span class="item_name" style="width:120px;">副图：</span>
       <img alt="" src="${basepath}/goodsupload/goods01.jpg" width="100px">
       <img alt="" src="${basepath}/goodsupload/goods02.jpg" width="100px">
       </li>
       <li>
...
<script src="${basepath}/js/bjs/ueditor.config.js"></script>
<script src="${basepath}/js/bjs/ueditor.all.min.js"> </script>
