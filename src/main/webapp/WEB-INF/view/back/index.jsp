...
<script src="${basepath}/js/bjs/amcharts.js" type="text/javascript"></script>
<script src="${basepath}/js/bjs/serial.js" type="text/javascript"></script>
<script src="${basepath}/js/bjs/pie.js" type="text/javascript"></script>
